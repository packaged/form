...
class FormTest extends TestCase
{
  ...
  public function testRender()
  {
    ...
    $this->assertRegExp(
      '/<form id="vbn" method="POST" class="p-form" action="\/test"><div class="p-form-field"><div class="p-form--label"><label for="text-(...)">Text<\/label><\/div><div class="p-form--input"><input type="text" name="text" placeholder="Text" id="text-\1" \/><\/div><\/div><div class="p-form-field"><div class="p-form--label"><label for="number-(...)">Number<\/label><\/div><div class="p-form--input"><input type="number" name="number" placeholder="Number" id="number-\2" \/><\/div><\/div><div class="p-form-field"><div class="p-form--label"><label for="read-only-(...)">Read Only<\/label><\/div><div class="p-form--input"><span id="read-only-\3"><\/span><\/div><\/div><div class="p-form-field"><input type="submit" value="Submit" \/><\/div><\/form>/',
      $form->render()
    );
    ...
    $form->text = 'abc';
    $this->assertRegExp(
      '/<form id="vbn" method="POST" class="p-form" action="\/test"><div class="p-form-field"><div class="p-form--label"><label for="text-(...)">Text<\/label><\/div><div class="p-form--input"><input type="text" name="text" placeholder="Text" value="abc" id="text-\1" \/><\/div><\/div><div class="p-form-field"><div class="p-form--label"><label for="number-(...)">Number<\/label><\/div><div class="p-form--input"><input type="number" name="number" placeholder="Number" value="4" id="number-\2" \/><\/div><\/div><div class="p-form-field"><div class="p-form--label"><label for="read-only-(...)">Read Only<\/label><\/div><div class="p-form--input"><span id="read-only-\3"><\/span><\/div><\/div><div class="p-form-field"><input type="submit" value="Submit" \/><\/div><\/form>/',
      $form->render()
    );
    ...
    $this->assertRegExp(
      '/<form id="abc" data-test method="POST" class="p-form" action="\/test"><div class="p-form-field"><div class="p-form--label"><label for="myInput">Text<\/label><\/div><div class="p-form--input"><input type="text" id="myInput" name="text" placeholder="Text" value="abc" \/><\/div><\/div><div class="p-form-field"><div class="p-form--label"><label for="number-(...)">Number<\/label><\/div><div class="p-form--input"><input type="number" name="number" placeholder="Number" value="4" id="number-\1" \/><\/div><\/div><div class="p-form-field"><div class="p-form--label"><label for="read-only-(...)">Read Only<\/label><\/div><div class="p-form--input"><span id="read-only-\2"><\/span><\/div><\/div><div class="p-form-field"><input type="submit" value="Submit" \/><\/div><\/form>/',
      $form->render()
    );
    ...
    $form->validate();
    $this->assertEquals(
      '<form id="abc" method="POST" class="p-form" action="/test"><div class="p-form-field"><div class="p-form--label"><label for="myInput">Text</label></div><div class="p-form--input"><input type="text" id="myInput" name="text" placeholder="Text" value="abc" /></div></div><div class="p-form-field"><div class="p-form--label"><label for="myNum">Number</label></div><div class="p-form--errors"><ul><li>must be a number</li></ul></div><div class="p-form--input"><input type="number" id="myNum" name="number" placeholder="Number" value="abc" /></div></div><div class="p-form-field"><div class="p-form--label"><label for="ro">Read Only</label></div><div class="p-form--input"><span id="ro"></span></div></div><div class="p-form-field"><input type="submit" value="Submit" /></div></form>',
      $form->render()
    );
